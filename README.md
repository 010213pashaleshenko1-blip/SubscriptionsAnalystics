...
- ⚡ **Автоматическая цена** — если пользователь включил автоцену и тариф есть в каталоге, стоимость и период подставятся сами
...
Он проверяет Kling/PixVerse, замену Roblox Premium → Roblox Plus и тарифы Roblox Plus 500/1000/2000 с автоценами.
