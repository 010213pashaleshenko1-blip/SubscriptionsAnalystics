...
- ⚡ **Автоматическая цена из интернета** — если подписка определена, цена не берётся из дефолта, а ищется на официальных страницах через интернет и подставляется автоматически
...
Он проверяет Kling/PixVerse, замену Roblox Premium → Roblox Plus, тарифы Roblox Plus 500/1000/2000 и то, что в каталоге больше нет захардкоженных дефолтных цен вроде 19.99 — цены берутся онлайн.
